...
const advertisements_resolver_1 = require("./advertisements.resolver");
const advertisements_controller_1 = require("./advertisements.controller");
const mongoose_1 = require("@nestjs/mongoose");
const advertisements_schema_1 = require("../models/advertisements.schema");
...
AdvertisementsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: "Advertisements", schema: advertisements_schema_1.AdvertisementsSchema }]),
            aws_module_1.AwsModule,
        ],
        providers: [advertisements_resolver_1.AdvertisementsResolver, advertisements_service_1.AdvertisementsService],
