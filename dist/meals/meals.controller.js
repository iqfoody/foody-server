...
let MealsController = class MealsController {
    ...
    async createMeal(createMealInput, file) {
    ...
    async updateMeal(updateMealInput, file) {
        ...
        return this.mealsService.update(updateMealInput.id, Object.assign(Object.assign({}, updateMealInput), { image: result === null || result === void 0 ? void 0 : result.Key }));
    }
};
__decorate([
    (0, common_1.Get)('/main'),
...
__decorate([
    ...
    __param(0, (0, common_1.Body)('createMealInput')),
    __param(1, (0, common_1.UploadedFile)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_meal_input_1.CreateMealInput, Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('image')),
    __param(0, (0, common_1.Body)('updateMealInput')),
    __param(1, (0, common_1.UploadedFile)()),
    __metadata("design:type", Function),
