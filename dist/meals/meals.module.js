...
const meals_resolver_1 = require("./meals.resolver");
const meals_controller_1 = require("./meals.controller");
const mongoose_1 = require("@nestjs/mongoose");
const meals_schema_1 = require("../models/meals.schema");
...
MealsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: "Meals", schema: meals_schema_1.MealsSchema }]),
            aws_module_1.AwsModule
        ],
        providers: [meals_resolver_1.MealsResolver, meals_service_1.MealsService],
