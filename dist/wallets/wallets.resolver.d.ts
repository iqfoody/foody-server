...
export declare class WalletsResolver {
    ...
    findOne(id: string): import("mongoose").Query<import("mongoose").Document<unknown, {}, import("../models/wallets.schema").WalletsDocument> & Omit<import("../models/wallets.schema").Wallets & import("mongoose").Document<any, any, any> & {
