...
const tags_schema_1 = require("../models/tags.schema");
...
TagsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: "Tags", schema: tags_schema_1.TagsSchema }]),
            aws_module_1.AwsModule,
        ],
        providers: [tags_resolver_1.TagsResolver, tags_service_1.TagsService],
