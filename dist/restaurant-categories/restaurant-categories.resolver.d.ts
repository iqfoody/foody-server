...
export declare class RestaurantCategoriesResolver {
    ...
    findAll(): import("mongoose").Query<(import("mongoose").Document<unknown, {}, import("../models/restaurantCategories.schema").RestaurantCategoriesDocument> & Omit<import("../models/restaurantCategories.schema").RestaurantCategories & import("mongoose").Document<any, any, any> & {
        _id: import("mongoose").Types.ObjectId;
